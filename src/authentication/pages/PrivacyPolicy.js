    ...
    <>
        <div className='auth-container privacy'>
            <AuthBanner
                ...
                titleWeb={"ZOG Global<br/>Careers"}
                titleTab={"ZOG Global Careers"}
                titleMob={"ZOG Global<br/>Careers"}
                paraWeb={""}
                paraTab={""}
                paraMob={""}
                buttonText=""
            ...
            <div className='policy card'>
                <div className='content'>
                    ...
                    <p>
                        ...
                        <br/>
                        <br/>
                        At Zog Global, we take data processing and protection seriously. For further details on how we oversee your information and ensure the protection of your rights regarding your data, kindly refer to our Privacy Notice.
                        <br/>
                        <br/>
                        ...
                        <ul>
                            <li><p>Zog Global is processing your Personal Data in connection with your application as described above</p></li>
